...
export default function PYQs() {
    ...
    return (
        <div className={`w-full bg-white flex flex-col`}>
            ...
            {
                selectedPYQ && <UpdatePYQModal selectedPYQ={selectedPYQ} setSelectedPYQ={setSelectedPYQ} refetchPYQs={refetchPYQs} />
            }
            <Head>
                <title>PYQs</title>
            ...
            <div className="grid grid-cols-5 gap-0 justify-center py-48 px-5 md:px-14 space-y-8 min-h-screen">
                ...
                <div className='col-span-5 flex w-full h-fit overflow-x-auto'>
                    <Table pyqs={pyqs} setSelectedPYQ={setSelectedPYQ} refetchPYQs={refetchPYQs} isDataFetching={isDataFetching} />
                </div>
            </div>
        </div>
    )
