...
export default function Notes() {
    ...
    return (
        <div className={`w-full bg-white flex flex-col`}>
            {
                user && <AddNoteModal refetchNotes={refetchNotes} showAddNoteModal={showAddNoteModal} setShowAddNoteModal={setShowAddNoteModal} />
            }
            <Head>
                <title>Notes</title>
            ...
            <div className="grid grid-cols-5 gap-0 justify-center py-48 px-5 md:px-14 space-y-8">
                <div
                ...
                <Table notes={notes} refetchNotes={refetchNotes} isDataFetching={isDataFetching} />
            </div>
        </div>
    )
}